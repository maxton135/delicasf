...
CREATE TABLE `__new_menu_categories` (
	...
	`created_at` text DEFAULT '2025-07-09T04:24:40.505Z' NOT NULL,
	`updated_at` text DEFAULT '2025-07-09T04:24:40.505Z' NOT NULL
);
...
CREATE TABLE `__new_menu_item_categories` (
	...
	`created_at` text DEFAULT '2025-07-09T04:24:40.506Z' NOT NULL,
...
CREATE TABLE `__new_menu_item_variations` (
	...
	`is_active` integer DEFAULT true NOT NULL,
	`created_at` text DEFAULT '2025-07-09T04:24:40.506Z' NOT NULL,
	`updated_at` text DEFAULT '2025-07-09T04:24:40.506Z' NOT NULL,
	FOREIGN KEY (`menu_item_id`) REFERENCES `menu_items`(`id`) ON UPDATE no action ON DELETE cascade
);
--> statement-breakpoint
