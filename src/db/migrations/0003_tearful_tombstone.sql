CREATE TABLE `display_categories` (
	...
	`created_at` text DEFAULT '2025-07-11T04:51:37.095Z' NOT NULL,
	`updated_at` text DEFAULT '2025-07-11T04:51:37.095Z' NOT NULL
);
--> statement-breakpoint
CREATE TABLE `menu_item_display_categories` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
...
CREATE TABLE `__new_menu_categories` (
	...
	`display_order` integer DEFAULT 0,
	`is_active` integer DEFAULT true NOT NULL,
	`created_at` text DEFAULT '2025-07-11T04:51:37.094Z' NOT NULL,
	`updated_at` text DEFAULT '2025-07-11T04:51:37.094Z' NOT NULL
);
--> statement-breakpoint
